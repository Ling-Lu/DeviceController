...
public class ColorPickerImagePreview extends ImageView implements ColorPickerDialog.OnColorChangedListener{
    ...
    public ColorPickerImagePreview(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes,int color) {
