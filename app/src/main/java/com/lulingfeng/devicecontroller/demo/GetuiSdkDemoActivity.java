package com.lulingfeng.devicecontroller.demo;
...
import com.lulingfeng.devicecontroller.CallbackIntentService;
import com.lulingfeng.devicecontroller.DeviceControllerApplication;
import com.lulingfeng.devicecontroller.DeviceControllerPushService;
import com.lulingfeng.devicecontroller.R;
...
public class GetuiSdkDemoActivity extends Activity implements OnClickListener {
    ...
    private static final String MASTERSECRET = "US6z2w89aR8SxBJBtq0OL1";
    ...
    private Class userPushService = DeviceControllerPushService.class;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        DeviceControllerApplication.demoActivity = this;
        ...
        PushManager.getInstance().registerPushIntentService(this.getApplicationContext(), CallbackIntentService.class);

        // 应用未启动, 个推 service已经被唤醒,显示该时间段内离线消息
        if (DeviceControllerApplication.payloadData != null) {
            tLogView.append(DeviceControllerApplication.payloadData);
        }
    ...
    public void onDestroy() {
        ...
        DeviceControllerApplication.payloadData.delete(0, DeviceControllerApplication.payloadData.length());
        super.onDestroy();
    }
    ...
    private void setSilentime() {
        final View view = LayoutInflater.from(this).inflate(R.layout.demo_silent_setting, null);
        AlertDialog.Builder alertBuilder = new AlertDialog.Builder(this);
